...
class HeaderNavigation extends Component
{
    ...
    public function store()
    {
        ...
        ModelsHeaderNavigation::updateOrCreate(['id' => $this->header_navigation_id], [
            'main_page_name1' => $this->main_page_names[0],
            'main_page_name2' => $this->main_page_names[1],
            'main_page_name3' => $this->main_page_names[2],
            'main_page_name4' => $this->main_page_names[3],
            'main_page_name5' => $this->main_page_names[4],
            'main_page_name6' => $this->main_page_names[5],
            'main_page_name7' => $this->main_page_names[6],
            'main_page_name8' => $this->main_page_names[7],
            'main_page_name9' => $this->main_page_names[8],
            'main_page_name10' => $this->main_page_names[9],
            'main_page_name11' => $this->main_page_names[10],
            'main_page_name12' => $this->main_page_names[11],
            'main_page_name19' => $this->main_page_names[19],
