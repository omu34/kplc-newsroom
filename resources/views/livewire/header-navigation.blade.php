<div x-data="{ isOpen: false, isSearchOpen: false }">
    ...
    <nav class="lg:flex hidden mx-auto max-w-5xl items-center bg-white px-6 py-2 rounded-md justify-between mt-6" aria-label="Global">
        <div class="flex lg:flex-1">
            <a href="#" class="-m-1.5 p-1.5">
                <span class="sr-only">Your Company</span>
                <img class="h-16 w-auto" src="/logo.png" alt="">
...
<div x-show="isSearchOpen" @click.away="isSearchOpen = false" class="relative z-10" role="dialog" aria-modal="true">
    <!--
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto p-4 sm:p-6 md:p-20">
      ...
      -->
      <div  class="mx-auto max-w-2xl transform divide-y divide-gray-500 divide-opacity-10 overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black ring-opacity-5 backdrop-blur backdrop-filter transition-all">
        <div class="relative">
        ...
        <div class="px-6 py-14 text-center sm:px-14">
          ...
          <p class="mt-4 text-sm text-gray-900">We couldn't find any news with that term. Please try again.</p>
          
          <svg @click="isSearchOpen = !isSearchOpen" class="mx-auto h-6 w-6 mt-4 text-gray-900 text-opacity-40" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
