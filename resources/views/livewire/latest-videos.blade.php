<div class="bg-cover testy bg-center py-12 sm:py-16">
    <div class="mx-auto lg:px-0 px-10 max-w-5xl">
        ...
        <div class="mx-auto  grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-4 lg:mx-0 lg:max-w-none lg:grid-cols-4">
                <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-4 pb-8 pt-44 sm:pt-60 lg:pt-48">
                    ...
                    <img src="/pdf-file-svgrepo-com.svg"
                        class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-28 h-12 w-12 fill-white"
                        alt="">
                    <!-- Metadata Section -->
                    ...
                    <div class="flex mt-4 flex-wrap items-center gap-y-1 overflow-hidden text-sm leading-6 text-gray-300">
                        <img src="/tag.png" class="mr-6" alt="">
                        <div class="-ml-4 flex items-center gap-x-4">
