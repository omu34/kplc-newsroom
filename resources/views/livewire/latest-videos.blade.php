<div>
    @php
    $videos = App\Models\LatestVideos::orderBy('created_at', 'asc')->take(4)->get();
@endphp
            ...
            <div class="bg-white dark:bg-gray-950 py-12 sm:py-16">
                ...
                <div
                    ...
                    <article class="relative isolate flex flex-col transition-transform transform hover:scale-105 justify-end overflow-hidden rounded-2xl bg-gray-900 px-4 pb-8 pt-44 sm:pt-60 lg:pt-48">
                        <a href="latest-gallery {{ $video->link }}" target="_blank" class="absolute inset-0 z-0">
                            <img src="{{ asset('storage/' . $video->file) }}" alt="" class="absolute inset-0 z-0 h-full w-full object-cover">
